...
const Hero = () => {
  ...
  <div className={`gap-y-14 pt-16 ${layout.container} grid`}>
    <div className="home__data">
      <h1 className="text-white font-poppin font-semibold text-4xl lg:text-6xl leading-[120%] mb-5">
        Discover <br /> Most Suitable <br /> Property
      </h1>
      <p className="home__description  text-emerald-200 mb-8">
        Find a variety of properties that suit you very easily, forget all
        difficulties in finding a residence for you
      </p>
      <form action="" className="bg-white flex items-center
